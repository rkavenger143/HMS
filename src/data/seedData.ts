...
export const DEMO_ADMISSIONS: Admission[] = [
  {
    ...
    bedId: 'bed-001', bedNumber: 'GA-01', ward: 'General Ward A', roomNumber: 'GW-101',
    admissionDate: '2026-08-28', admissionTime: '14:30', expectedDischargeDate: '2026-09-02', status: 'active',
    condition: 'improving', priority: 'urgent', dischargeReadiness: 'planned_discharge',
  ...
  },
  {
    ...
    admittingDoctorId: 'doc-001', admittingDoctorName: 'Dr. Rajesh Kumar',
    bedId: 'bed-003', bedNumber: 'GA-03', ward: 'General Ward A', roomNumber: 'GW-102',
    admissionDate: '2026-08-30', admissionTime: '11:00', expectedDischargeDate: '2026-09-04', status: 'active',
    condition: 'stable', priority: 'routine', dischargeReadiness: 'under_treatment',
  ...
  },
  {
    ...
    bedId: 'bed-010', bedNumber: 'PR-01', ward: 'Private Ward', roomNumber: 'PVT-201',
    admissionDate: '2026-08-29', admissionTime: '09:00', expectedDischargeDate: '2026-09-03', status: 'active',
    condition: 'improving', priority: 'routine', dischargeReadiness: 'under_treatment',
  ...
  },
  {
    ...
    admittingDoctorId: 'doc-001', admittingDoctorName: 'Dr. Rajesh Kumar',
    bedId: 'bed-020', bedNumber: 'MICU-01', ward: 'Medical ICU', roomNumber: 'ICU-301',
    admissionDate: '2026-08-31', admissionTime: '02:15', expectedDischargeDate: '2026-09-06', status: 'active',
    condition: 'critical', priority: 'emergency', dischargeReadiness: 'under_treatment',
    diagnosis: ['Acute MI', 'Cardiogenic Shock'],
    admissionNotes: 'Emergency admission. Thrombolysis given. Continuous arterial monitoring.',
...
export const DEMO_NURSES: Nurse[] = [
  {
    id: 'nur-001',
    userId: 'u-006',
    name: 'Kavitha Nair',
  ...
  },
  {
    ...
    ward: 'Medical ICU',
    phone: '9876543208',
    email: 'rekha.sharma@alnhms.com',
    qualification: 'M.Sc Critical Care Nursing',
    experienceYears: 8,
    status: 'on_duty',
    shift: 'morning',
  ...
  },
  {
    ...
    userId: 'u-009',
    name: 'Preethi Mathew',
    employeeId: 'EMP-NUR-104',
    department: 'Emergency & Triage',
    ward: 'Emergency Ward',
    phone: '9876543211',
    email: 'preethi.mathew@alnhms.com',
    qualification: 'B.Sc Nursing & Trauma Care',
    experienceYears: 5,
    status: 'active',
    shift: 'afternoon',
  ...
  },
  {
    ...
    userId: 'u-010',
    name: 'Anitha Varma',
    employeeId: 'EMP-NUR-105',
    department: 'General Ward',
    ward: 'General Ward B',
    phone: '9876543212',
    email: 'anitha.varma@alnhms.com',
    qualification: 'GNM',
    experienceYears: 3,
    status: 'active',
    shift: 'night',
  ...
  },
  {
    ...
    userId: 'u-011',
    name: 'Meena Joseph',
    employeeId: 'EMP-NUR-106',
    department: 'Surgery & HDU',
    ward: 'HDU Ward',
    phone: '9876543213',
    email: 'meena.joseph@alnhms.com',
    qualification: 'Post Basic B.Sc Nursing',
    experienceYears: 7,
    status: 'on_leave',
    shift: 'morning',
